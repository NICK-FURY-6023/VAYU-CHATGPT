...
HUGGING_FACE_API = "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" # Grab your hugging face api key at https://huggingface.co/settings/tokens | (You can leave it but you will not have access to Image, music and object detection generation)
#Discord Bot's Name
NAME = "VAYU CHATGPT" # Change it to what you want to name the AI Bot | The AI bot will use the name for conversations and chats 
# Server Name
server_name = "VAYU ESPORTS" # Replace with your server name
# Creator Name
creator = "NICK FURY" # You can edit it to your name.
